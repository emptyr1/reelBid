...
public class KafkaSpoutTopologyMain {
    ...
    private static final String[] TOPICS = new String[]{"mytopic"};
    ...
    public static StormTopology getTopolgyKafkaSpout() {
        ...
        //tp.setSpout("kafka_spout", new KafkaSpount<>.shuffleGrouping();
        tp.setBolt("filter_text_bolt", new FilterText()).shuffleGrouping("kafka_spout", STREAMS[0]);

        tp.setBolt("hdfs_bolt", new Writetohdfs()).shuffleGrouping("filter_text_bolt");
        //tp.setBolt("writeto_cassandra_bolt"), new Writetocassandra()).shuffleGrouping("filter_text_bolt");
        //tp.setBolt("sendPost_bolt"), new SendBidRespBolt()).shuffleGrouping("filter_text_bolt");

        //tp.setBolt("kafka_bolt", new KafkaSpoutTestBolt()).shuffleGrouping("kafka_spout", STREAMS[0]);
        //tp.setBolt("kafka_bolt_1", new KafkaSpoutTestBolt()).shuffleGrouping("filter_text_bolt");
...
//        props.put(KafkaSpoutConfig.Consumer.ENABLE_AUTO_COMMIT, "true");
    ...
    public static KafkaSpoutTuplesBuilder<String, String> getTuplesBuilder() {
        return new KafkaSpoutTuplesBuilder.Builder<>(
                new TopicfromKafkaBuilderMudit<String, String> (TOPICS[0]))
    ...
    public static KafkaSpoutStreams getKafkaSpoutStreams() {
        ...
        final Fields outputFields = new Fields("topic", "value");
